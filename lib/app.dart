...
class _RouteChecker {
  ...
  static bool isPreviewScreen(String location) => _isUnder(location, '/kiosk/preview');
  ...
  /// `contains('/kiosk')`는 `/setup/kiosk-info`·`/setup/kiosk-components`까지
  /// 키오스크 화면으로 오인해 관리자 화면에 타임아웃이 걸렸다.
