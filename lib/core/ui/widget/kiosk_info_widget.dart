        ...
        Row(
          ...
          children: [
            Container(
              ...
              color: info.mainButtonColor.toColor(),
            ),
            Container(
              width: 50,
              height: 50,
              margin: const EdgeInsets.all(8),
              color: info.buttonTextColor.toColor(),
            ),
            Container(
              width: 50,
              height: 50,
              margin: const EdgeInsets.all(8),
              color: info.couponTextColor.toColor(),
            ),
            Container(
              width: 50,
              height: 50,
              margin: const EdgeInsets.all(8),
              color: info.mainTextColor.toColor(),
            ),
            Container(
              width: 50,
              height: 50,
              margin: const EdgeInsets.all(8),
              color: info.popupButtonColor.toColor(),
            ),
            Container(
              width: 50,
              height: 50,
              margin: const EdgeInsets.all(8),
              color: info.keyPadColor.toColor(),
            ),
          ],
        ),
      ],
